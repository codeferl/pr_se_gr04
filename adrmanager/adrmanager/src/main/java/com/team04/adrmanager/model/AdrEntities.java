...
public class AdrEntities implements Serializable {
    ...
    public AdrEntities(String titel, String context, String decisions, String status, String consequenes,  List<Commit> commit, List<Artifact> artifacts, List<Relation> relations) {
        this.titel = titel;
